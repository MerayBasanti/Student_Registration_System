...
public class classroom {
    ...
    public classroom(int classroom_id,String location,int capacity_of_classroom) {
        ...
        this.capacity_of_classroom = capacity;
            ...
            public void add_courses(courses courses, String day, int period) {
                ...
                if (dayIndex != -1 && period < 5 && table_of_courses[dayIndex][period] == null) {
                    ...
                    System.out.println("YOUR PERIOD INPUT IS OUT OF BOUNDS, INPUT VALUE THAT IS LESS THAN 4");
                }
            }
